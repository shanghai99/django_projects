...
def run():
    ...
    for row in reader:
        ...
        site = Site(name=row[0], description=row[1], justification=row[2], year=y, longitude=o, latitude=a, area_hectares=h, category=c, states=s, region=r, iso=i)
        site.save()
